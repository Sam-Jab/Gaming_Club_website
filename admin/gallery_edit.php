...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <h6 class="m-0 font-weight-bold text-primary ">Edit a Gallery </h6>
</div>
    ...
    foreach($query_run as $row){
        ...
        if(isset($_SESSION['status']) && $_SESSION['status'] != '') {
            ...
            <div class="form-group">
                <label> Caption </label>
                <input type="text" name="edit_caption" value="<?php echo $row['caption'] ?>" class="form-control" placeholder="Enter the Title">
            </div>
            <div class="form-group">
            ...
            <div>
                ...
                <button type="submit" name="updatebtn_gallery" class="btn btn-primary">UPDATE</button>
            </div>
        </form>
            <?php
    }
