  ...
  <section id="navigation">
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <a class="navbar-brand" href="">FSTT</a>
        ...
        <div id="homenavbar" class="collapse navbar-collapse">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link smoothScroll" href="#">About us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link smoothScroll" href="#">What we offer</a>
            </li>
            <li class="nav-item">
